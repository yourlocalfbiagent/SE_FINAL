...
CREATE TABLE USERS (
    ...
    company_id BIGINT, -- Reference to external COMPANIES
    role_id BIGINT,    -- Reference to external ROLES
...
CREATE TABLE PRODUCTS (
    ...
    category_id BIGINT, -- Reference to external PRODUCT_CATEGORIES
    company_id BIGINT,  -- Reference to external COMPANIES
    is_active BOOLEAN DEFAULT TRUE,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);
